...
class Company extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('name, skill, major_id', 'required'),
			array('major_id', 'numerical', 'integerOnly'=>true),
			...
			array('id, name, description, phone, link, skill, major_id', 'safe', 'on'=>'search'),
		);
	}
